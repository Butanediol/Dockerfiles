...
with app:
    ...
    help_me_write_button.click(
        ...
        api_name='help_me_write'
    )
    topic_button.click(
        write_by_topic, inputs=[topic_type, topic_prompt], outputs=topic_output, api_name='topic'
    )
    translate_button.click(
        translate, inputs=[translate_language, translate_text], outputs=translate_output, api_name='translate'
    )
    change_tone_button.click(change_tone, inputs=[tone, tone_text], outputs=tone_output, api_name='change_tone')
